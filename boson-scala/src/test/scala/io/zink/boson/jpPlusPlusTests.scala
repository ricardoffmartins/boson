...
class jpPlusPlusTests extends FunSuite{
  ...
  val validatedByteArr: Array[Byte] = bsonEvent.encodeToBarray()
    ...
    test("Inj .key"){
      ...
      val future: CompletableFuture[BsValue] = new CompletableFuture[BsValue]()
      val bosonE: Boson = BosonObject.extractor(expression, (out: BsValue) => future.complete(out))
    ...
    test("Inj .key1.key2"){
      ...
      //val bosonI: Boson = BosonObject.injector(expression, (x: List[Any]) => x.+:("Street?"))
    ...
    test("Inj .key1.key2[# to end].key3"){
      ...
      val bosonI: Boson = BosonObject.injector(expression, (x: Double) => x + 10)
      val injFuture: CompletableFuture[Array[Byte]] = bosonI.go(validatedByteArr)
    ...
    test("Inj .key1.key2[@elem].key3"){
      ...
      val bosonI: Boson = BosonObject.injector(expression, (x: String) => x.concat("!!!"))
      val injFuture: CompletableFuture[Array[Byte]] = bosonI.go(validatedByteArr)
    ...
    test("Inj ..key1[#]..key2"){
      ...
      val bosonI: Boson = BosonObject.injector(expression, (x: Int) => x + 10)
      val injFuture: CompletableFuture[Array[Byte]] = bosonI.go(validatedByteArr)
      //println("injFuture=" + new String(injFuture.join()))
    ...
    test("Inj ..key1..*ey2..*ey3"){
      ...
      //val bosonI: Boson = BosonObject.injector(expression, (x: List[Any]) => x.:+("NewEdition!"))
      val bosonI: Boson = BosonObject.injector(expression, (x: Array[Byte]) => {
        val b: BosonImpl = new BosonImpl(byteArray = Option(x))
        val l: List[Any] = Mapper.decodeBsonArray(b.getByteBuf)
    ...
    test("Inj .key.*"){
      ...
      //val bosonI: Boson = BosonObject.injector(expression, (x: List[Any]) => x.:+("newField!"))
      val bosonI: Boson = BosonObject.injector(expression, (x: Array[Byte]) => {
        val b: BosonImpl = new BosonImpl(byteArray = Option(x))
        val l: List[Any] = Mapper.decodeBsonArray(b.getByteBuf)
...
//    } //TODO: Not implemented yet, so this test is wrong
    ...
    val expression: String = "..*"
      ...
      //val bosonI: Boson = BosonObject.injector(expression, (x: List[Any]) => x.+:("ADDED"))
      val bosonI: Boson = BosonObject.injector(expression, (x: Array[Byte]) => {
        val b: BosonImpl = new BosonImpl(byteArray = Option(x))

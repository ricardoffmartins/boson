...
import io.zink.bosonInterface.{Boson, BosonObject}
...
class jpPlusPlusInjectorTests extends FunSuite {
  ...
  test(".Store.Book..0.Title") {
    ...
    val boson: Boson = BosonObject.injector(expression, (x: String) => "SUPERJAVA")
  ...
  test("Inj ..Books[0 until end]"){
    ...
    val bosonI: Boson = BosonObject.injector(expression, (x: Array[Byte]) => {
      val b: BosonImpl = new BosonImpl(byteArray = Option(x))
      val m: Map[String,Any] = Mapper.decodeBsonObject(b.getByteBuf)
  ...
  test("Inj .key1..key2[#]..key3[@elem]"){
    ...
    val boson: Boson = BosonObject.extractor(expression, (out: BsValue) => future.complete(out))
  ...
  test("Inj ROOT OBJECT -> ."){
    ...
    val bosonEx: Boson = BosonObject.extractor(".Another", (out: BsValue) => futureEx.complete(out))
    bosonEx.go(result)
  ...
  test("Inj ROOT ARRAY -> ."){
    ...
    val result: Array[Byte] = future.join()
    val futureEx: CompletableFuture[BsValue] = new CompletableFuture[BsValue]()
    val bosonEx: Boson = BosonObject.extractor(".[2]", (out: BsValue) => futureEx.complete(out))
    bosonEx.go(result)
  ...
  test("Inj .[first]"){
    ...
    val result: Array[Byte] = future.join()
    val futureEx: CompletableFuture[BsValue] = new CompletableFuture[BsValue]()
    val bosonEx: Boson = BosonObject.extractor(".Store3ComingSoon", (out: BsValue) => futureEx.complete(out))
    bosonEx.go(result)
  ...
  test("Inj key1.[end]"){
    ...
    val boson: Boson = BosonObject.injector("field1.[end]", (x: Int) => x*3 )
  ...
  test("Inj .[end].key2"){
    ...
    val boson: Boson = BosonObject.injector(".[end].field2", (x: Int) => x*3 )
  ...
  test("Inj key1.[end].key2"){
    ...
    val boson: Boson = BosonObject.injector(".field1.[end].field2", (x: Int) => x*3 )
  ...
  test("Inj key1.[#]"){
    ...
    val boson: Boson = BosonObject.injector(".field1.[1]",(x: Array[Byte]) => {
      val b: BosonImpl = new BosonImpl(byteArray = Option(x))
      val l: List[Any] = Mapper.decodeBsonArray(b.getByteBuf)
  ...
  test("Inj ."){
    ...
    val boson: Boson = BosonObject.injector(".",(x:Int)=> 10)
  ...
  test("match key but ain´t array ."){
    ...
    val boson: Boson = BosonObject.injector(expression,(x: Array[Byte])=> x.reverse)
  ...
  test("testing * V1") {
    ...
    val boson: Boson = BosonObject.injector(expression, (x:String) => x.concat("!!!") )
    val future: CompletableFuture[Array[Byte]] = boson.go(validatedByteArr)
    val result: Array[Byte] = future.join()
    val bE: Array[Byte] = bsoneventx.encodeToBarray()
    assertTrue(bE.zip(result).forall(p => p._1 == p._2))
  ...
  test("Coverage V3 modifierAll Float ") {
    ...
    val boson: Boson = BosonObject.injector(expression, (x:Float) => x+0.7f )
    val future: CompletableFuture[Array[Byte]] = boson.go(validatedByteArr)
    val result: Array[Byte] = future.join()
    val bE: Array[Byte] = bsoneventx.encodeToBarray()
    assertTrue(bE.zip(result).forall(p => p._1 == p._2))
  ...
  test("Coverage V4 modifierAll Double ") {
    ...
    val expression: String = ".other"
    val boson: Boson = BosonObject.injector(expression, (x:Double) => x+0.7 )
    val future: CompletableFuture[Array[Byte]] = boson.go(validatedByteArr)
    val result: Array[Byte] = future.join()
    val bE: Array[Byte] = bsoneventx.encodeToBarray()
    assertTrue(bE.zip(result).forall(p => p._1 == p._2))
  ...
  test("Coverage V6 modifierAll Instant ") {
    ...
    val expression: String = "..BooK"
    val boson: Boson = BosonObject.injector(expression, (x:Instant) => {
      x.plusMillis(1000)
    })
    val future: CompletableFuture[Array[Byte]] = boson.go(validatedByteArr)
    val result: Array[Byte] = future.join()
  ...
  test("Coverage V8 modifierAll Long ") {
    ...
    val boson: Boson = BosonObject.injector(expression, (x:Long) => {
     x+5L
    })
    val future: CompletableFuture[Array[Byte]] = boson.go(validatedByteArr)
    val result: Array[Byte] = future.join()
  ...
  test("Coverage V9 modifierAll Boolean ") {
    ...
    val boson: Boson = BosonObject.injector(expression, (x:Boolean) => {
      !x
    })
    val future: CompletableFuture[Array[Byte]] = boson.go(validatedByteArr)
    val result: Array[Byte] = future.join()
  ...
  test("Coverage V10 modifierAll wrong type Double/String ") {
    ...
    val expression: String = ".other"
    val boson: Boson = BosonObject.injector(expression, (x:String) => {
      x
    })
    val future: CompletableFuture[Array[Byte]] = boson.go(validatedByteArr)
    val result: Array[Byte] = future.join()
  ...
  test("Coverage V11 modifierEnd Double ") {
    ...
    val boson: Boson = BosonObject.injector(expression, (x:Double) => {
      x+1.0
    })
    val future: CompletableFuture[Array[Byte]] = boson.go(validatedByteArr)
    val result: Array[Byte] = future.join()
  ...
  test("Coverage V12 modifierEnd Float ") {
    ...
    val expression: String = "..[all]"
    val boson: Boson = BosonObject.injector(expression, (x:Float) => {
      x+1.0f
    })
    val future: CompletableFuture[Array[Byte]] = boson.go(validatedByteArr)
    val result: Array[Byte] = future.join()
  ...
  test("Coverage V19 modifierEnd Boolean Exception") {
    ...
    val expression: String = "..[all]"
    val boson: Boson = BosonObject.injector(expression, (x:Int) => {
      x+1
    })
    val future: CompletableFuture[Array[Byte]] = boson.go(validatedByteArr)
    val result: Array[Byte] = future.join()
  ...
  test("Coverage V66 "){
    ...
    val validatedByteArr: Array[Byte] = bsonevent.encodeToBarray()
    val expression: String = ".Store[@bool]"
    val boson: Boson = BosonObject.injector(expression, (x:Array[Byte]) => new BsonObject().encodeToBarray())
    val future: CompletableFuture[Array[Byte]] = boson.go(validatedByteArr)
    val result: Array[Byte] = future.join()
    val bE: Array[Byte] = bsoneventx.encodeToBarray()
    ////bE.zip(result).foreach(p => println("["+p._1.toChar+"|"+p._2.toChar+"]"))
  ...
  test("Coverage V67 "){
    ...
    val boson: Boson = BosonObject.injector(expression, (x:Array[Byte]) => new BsonArray().encodeToBarray())
    val future: CompletableFuture[Array[Byte]] = boson.go(validatedByteArr)
    val result: Array[Byte] = future.join()
    val bE: Array[Byte] = bsoneventx.encodeToBarray()
    ////bE.zip(result).foreach(p => println("["+p._1.toChar+"|"+p._2.toChar+"]"))
